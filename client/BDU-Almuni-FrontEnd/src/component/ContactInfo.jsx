...
const ContactInfo = ({display,personalInfo,close,forsocials,edit,handlePlaceholders}) => {
  ...
  useEffect(()=>{
    const settingSocialfromDatabase=()=>{
      const SocialfromDatabase = JSON.parse(personalInfo[0].socialMedia);
    ...
    <div className='contactInfo_container' >
       ...
       { display&&<div className="title_and_edit">
          ...
          <form onSubmit={sub} className={edit?"social_inputs_form":"only_social_icons"}>
            ...
            {edit&&<input  type="text" name="" className="social_inputs" value={socialValues?.[0]} placeholder={"please drop your social media handles"} onChange={(e) =>handleSocialChange(0,e.target.value)}/>}</div>
            <div className="social">
            ...
            {edit&&<input type="text" name="" className="social_inputs" value={socialValues?.[1]} placeholder={"please drop your social media handles"} onChange={(e) =>handleSocialChange(1,e.target.value)}/>}</div>
            <div className="social">
            ...
            {edit&&<input type="text" name="" className="social_inputs" value={socialValues?.[2]} placeholder={"please drop your social media handles"} onChange={(e) =>handleSocialChange(2,e.target.value)} />}</div>
