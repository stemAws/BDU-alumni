...
import {FaUsers, FaCalendarAlt, FaTimes, FaMoneyCheck, FaMapMarker, FaPhone, FaEnvelope} from 'react-icons/fa';
    ...
    <div className="JO-popup-container">
        ...
        <div className="company-detail">
            {/* <img src={jobOffer?.profilePicture} alt="" className="company-logo" /> */}
                ...
                <p className="JO-upload-date">{ new Date(jobOffer?.createdAt).toLocaleDateString('default', {
                year: 'numeric',
                month: 'long',
                day: 'numeric'
                })}</p>
        ...
        <div className="JO-bottom">
            ...
            <Link to={`/profilePage/${jobOffer?.username}`}><div className="name-profile">
            <img src={jobOffer?.profilePicture} alt="" className="company-logo" /> 
            <p>{jobOffer?.fullName}</p> 
                ...
                <div className="job-need JO JO-deadline">
                    <FaCalendarAlt />
                    <p className="JO-up-to">up to { new Date(jobOffer?.deadline).toLocaleDateString('default', {
                year: 'numeric',
                month: 'long',
                day: 'numeric'
                })}</p>
