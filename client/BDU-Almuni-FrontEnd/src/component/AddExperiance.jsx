...
const AddExperiance = ({
  ...
  return (
    <form
      className="add_form"
      onSubmit={showEditExperiance ? onupdate : onSubmit}
    >
      ...
      {jobTitleError && (
        <p style={{ color: "red" }}>
          Job Title must be less than 27 characters
        </p>
      )}
      <div className="form_control">
      ...
      <div className="form_control">
        ...
        >
          ...
          <option value="Administrative and Support and Waste Management Services">
      ...
      <div className="save_discard">
        {showEditExperiance ? (
          <input
            ...
            type="submit"
            value={loading ? "Upadting..." : "Update changes"}
          />
        ) : (
          <input
            disabled={loading}
            className="save_button"
            type="submit"
            value={loading ? "Adding..." : "ADD Experiance"}
          />
        )}
        {showEditExperiance && (
          <input
